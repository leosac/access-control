...
/**
 * CRUD Handler for GPIO backed by Libgpiod module.
 *
...
private:
    // Enforce uniqueness of GPIO name and device
    void validate_uniqueness(const std::string& name, const std::string& device);
};
