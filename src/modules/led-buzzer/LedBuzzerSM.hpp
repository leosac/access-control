                ...
                */
                ...
                struct LedBuzzerSM_ : msmf::state_machine_def<LedBuzzerSM_>
                {
                    ...
                    struct PlayingPattern : msmf::state<>
                    {
                        ...
                        {
                            // we are coming back to PlayingPattern after finishing 1 round of blinking.
                        }
                    ...
                    struct StateBlinking : msmf::state<>
                    {
                        ...
                        {
                            DEBUG("StateBlinking::on_entry(). Duration = " << e.duration << ". Speed = " << e.speed);
                            fsm.next_update_time_ = std::chrono::system_clock::now();
                    ...
                    */
                    ...
                    struct transition_table : boost::mpl::vector<
                            ...
                            msmf::Row < Idle, EventBlink, StateBlinking, msmf::none, msmf::none>,
                                              msmf::Row<StateBlinking, EventBlinkStop, Idle, msmf::none, transition_guard>,
                                              msmf::Row<StateBlinking, EventBlinkStop, PlayingPattern, msmf::none, transition_guard>,
                                              msmf::Row<StateBlinking, EventUpdate, msmf::none, UpdateAction, msmf::none>,
                                              msmf::Row<Idle, EventPlayingPattern, PlayingPattern, msmf::none, msmf::none>,
                                              msmf::Row<PlayingPattern, EventUpdate, msmf::none, UpdateAction, msmf::none>,
                                              msmf::Row<PlayingPattern, EventBlink, StateBlinking, msmf::none, msmf::none>,
                                              msmf::Row<PlayingPattern, EventPlayingPatternStop, Idle, msmf::none, msmf::none>
                            >
                    {
                    };
