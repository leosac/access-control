...
{
CancelUpdate::CancelUpdate(RequestContext ctx)
    : MethodHandler(ctx)
{
}

MethodHandlerUPtr CancelUpdate::create(RequestContext ctx)
{
    return std::make_unique<CancelUpdate>(ctx);
}
