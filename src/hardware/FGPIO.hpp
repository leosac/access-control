...
* This facade does not care about the GPIO implementation. It uses message passing to
* interact
* with the application "gpio controller".
*
* The backend GPIO object (implemented by the gpio module (either sysfs or piface))
* MUST exist.
