#!/bin/bash
##
## The Test and Reset has a promiscuous mode, allowing
## it to watch on all potential device, opportunistically trying
## to detect the reset card (this is pratical to still be able to reset
