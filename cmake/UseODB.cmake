...
function(odb_compile outvar)
  ...
  if(PARAM_HXX_PROLOGUE)
    list(APPEND ODB_ARGS --hxx-prologue "${PARAM_HXX_PROLOGUE}")
  endif()
  ...
  if(PARAM_OUTPUT_DIR)
    set(ODB_COMPILE_OUTPUT_DIR "${PARAM_OUTPUT_DIR}")
  endif()
  ...
  # file(REMOVE_RECURSE "${ODB_COMPILE_OUTPUT_DIR}") # Temporary for debugging and fast make
  # file(MAKE_DIRECTORY "${ODB_COMPILE_OUTPUT_DIR}") # Temporary for debugging and fast make
