...
TEST(AutomatonTest, SimpleGraph)
{
    ...
    dfa.addNode(1, [] (std::string& val) { val = "I"; } );
    dfa.addNode(2, [] (std::string& val) { val += " f*cking"; } );
    dfa.addNode(3, [] (std::string& val) { val += " hate"; } );
    dfa.addNode(4, [] (std::string& val) { val += " love"; } );
    dfa.addNode(5, [] (std::string& val) { val += " c++"; } );
