...
class ConfigManagerTest : public ::testing::Test
{
  public:
    ConfigManagerTest()
    {
        ...
        auto cfg_tree =
            Tools::propertyTreeFromXmlFile(gl_data_path + "ConfigManager1.xml");
        cfg1 = std::make_shared<ConfigManager>(cfg_tree.get_child("kernel"));

        cfg_tree =
            Tools::propertyTreeFromXmlFile(gl_data_path + "ConfigManager2.xml");
        cfg2 = std::make_shared<ConfigManager>(cfg_tree.get_child("kernel"));

        cfg_tree =
            Tools::propertyTreeFromXmlFile(gl_data_path + "ConfigManager3.xml");
        cfg3 = std::make_shared<ConfigManager>(cfg_tree.get_child("kernel"));

        cfg_tree =
            Tools::propertyTreeFromXmlFile(gl_data_path + "ConfigManager4.xml");
        cfg4 = std::make_shared<ConfigManager>(cfg_tree.get_child("kernel"));

        cfg_tree =
            Tools::propertyTreeFromXmlFile(gl_data_path + "ConfigManager5.xml");
        cfg5 = std::make_shared<ConfigManager>(cfg_tree.get_child("kernel"));

        cfg_tree =
            Tools::propertyTreeFromXmlFile(gl_data_path + "ConfigManager6.xml");
        cfg6 = std::make_shared<ConfigManager>(cfg_tree.get_child("kernel"));

        cfg_tree =
            Tools::propertyTreeFromXmlFile(gl_data_path + "ConfigManager7.xml");
        cfg7 = std::make_shared<ConfigManager>(cfg_tree.get_child("kernel"));

        cfg_tree =
            Tools::propertyTreeFromXmlFile(gl_data_path + "ConfigManager8.xml");
